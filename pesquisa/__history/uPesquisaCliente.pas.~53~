...
type
  TfrmPesquisaCliente = class(TForm)
    ...
    qryPesquisaClientecodigo: TIntegerField;
    qryPesquisaClientenome: TWideStringField;
    qryPesquisaClientedata_cadastro: TDateField;
    qryPesquisaClientecpf: TWideStringField;
    qryPesquisaClientetelefone: TWideStringField;
    qryPesquisaClienteemail: TWideStringField;
    qryPesquisaClientedata_nascimento: TDateField;
    qryPesquisaClientecep: TWideStringField;
    qryPesquisaClientebairro: TWideStringField;
    qryPesquisaClientelogradouro: TWideStringField;
    qryPesquisaClientenumero: TWideStringField;
    qryPesquisaClientecomplemento: TWideStringField;
    qryPesquisaClientepais: TWideStringField;
...
procedure TfrmPesquisaCliente.dbPesquisaClienteDblClick(Sender: TObject);
begin
  if not qryPesquisaCliente.IsEmpty then
  begin
    FCodigoSelecionado := qryPesquisaClientecodigo.AsInteger;
    ModalResult := mrOk; // Fecha o form
  end;
end;

procedure TfrmPesquisaCliente.btConfirmarClick(Sender: TObject);
begin
  if not qryPesquisaCliente.IsEmpty then
  begin
    FCodigoSelecionado := qryPesquisaClientecodigo.AsInteger;
...
function TfrmPesquisaCliente.SelecionarCliente: Integer;
begin
